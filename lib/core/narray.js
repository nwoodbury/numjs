...
/**
 * Pads elements to the beginning of the array until the array length
 ...
 */
exports.PrePad = function(arr, length, value) {
...
/**
 * Pads elements to the end of the array until the array length is greater
 ...
 * @return {Array} The padded array
 */
exports.PostPad = function(arr, length, value) {
    // TODO typecheck parameters
    arr = this.Clone(arr);
    while (arr.length < length) {
        arr.push(value);
